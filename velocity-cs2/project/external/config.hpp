...
namespace config {
	...
	namespace words {
		...
		inline constexpr const char* k_wordlist[ 256 ]
		{
			...
			"someone tried to leave a 'was here'", "weener", "vertex.cc core1!!11", "spiderman 3", "ironman 3", "//^_^//", "wiggle", "tappy",
	...
	namespace registry {
		...
		inline constexpr wchar_t k_root_key[ ]{ L"Software\\vertex\\configs" };
