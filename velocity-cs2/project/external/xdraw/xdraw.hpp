...
namespace tokens {
	...
	inline xdraw::color col_accent{ 233, 43, 106, 255 };
	inline xdraw::color col_dark{ 14, 12, 26, 255 };
	inline xdraw::color col_text{ 245, 243, 255, 255 };
	inline xdraw::color col_text_dim{ 160, 155, 190, 255 };
	inline xdraw::color col_card{ 21, 18, 38, 245 };
	inline xdraw::color col_elevated{ 36, 31, 62, 255 };

	constexpr auto sidebar_w{ 0.0f };
	constexpr auto header_h{ 48.0f };
	constexpr auto footer_h{ 30.0f };
	constexpr auto tab_icon_size{ 18.0f };
	constexpr auto subtab_bar_h{ 32.0f };
	constexpr auto gap{ 10.0f };
	inline float card_rounding{ 8.0f };
	inline float btn_rounding{ 6.0f };
