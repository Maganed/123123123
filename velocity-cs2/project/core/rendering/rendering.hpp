...
namespace rendering {
    ...
    public:
        ...
        enum class tab : int
        {
            ragebot, legitbot, visuals, misc, skins, config, count
        };
    ...
    private:
        ...
        void draw_subtabs( float x, float y, float w, float h );
		...
		bool m_search_open{};
		bool m_customizer_open{};
		float m_customizer_anim{ 0.0f };
		float m_customizer_x{ -1.0f };
		float m_customizer_y{ -1.0f };
		float m_customizer_w{ 520.0f };
		float m_customizer_h{ 460.0f };
		int m_theme_preset{};
        ...
        static constexpr subtab_info k_subtab_defs[ static_cast< int >( tab::count ) ]
        {
            ...
            { { "pistol", "smg", "rifle", "shotgun", "sniper", "lmg" }, 6 },
            { { "enemy", "teammate", "local", "items", "world", "weather" }, 6 },
            { { "general" },                                            0 },
